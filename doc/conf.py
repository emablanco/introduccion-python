# -*- coding: utf-8 -*-
#
# Introducción al desarrollo de software documentation build configuration file, created by
...
project = u'Introducción al desarrollo de software'
copyright = u'2015, Emiliano López'
...
htmlhelp_basename = 'Introduccinaldesarrollodesoftwaredoc'
...
texinfo_documents = [
  ('index', 'Introduccinaldesarrollodesoftware', u'Introducción al desarrollo de software Documentation',
   u'Emiliano López', 'Introduccinaldesarrollodesoftware', 'One line description of project.',
   'Miscellaneous'),
]
